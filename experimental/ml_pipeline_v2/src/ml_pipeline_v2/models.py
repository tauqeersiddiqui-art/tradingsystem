...
def regime_classifier_candidates(random_state: int = 42) -> list[ModelSpec]:
    specs: list[ModelSpec] = []
    ...
    try:
        ...
        specs.append(ModelSpec("lgbm", "regime_classifier", False, None, str(exc)))
    ...
    try:
        ...
        specs.append(ModelSpec("catboost", "regime_classifier", False, None, str(exc)))
    ...
    try:
        ...
        specs.append(ModelSpec("xgboost", "regime_classifier", False, None, str(exc)))
